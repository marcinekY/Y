...
public class ColorPickerPalette extends Composite implements MouseMoveHandler,
		MouseDownHandler, HasSelectionHandlers<String> {

	public static final String[] hexValues = { "00", "33", "66", "99", "CC",
			"FF" };
